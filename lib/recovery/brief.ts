...
// label cannot be parsed, return it unchanged so we never error out.
...
// Hide internal fixture paths from customer-facing briefs and surface an
// honest label instead. A real customer brief should show "Uploaded list"
// or omit entirely.
