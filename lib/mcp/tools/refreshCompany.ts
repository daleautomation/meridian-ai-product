    ...
    return {
      ...
      data: {
        decision: {
          ...
          callAttempts: 0, consecutiveNoAnswers: 0, escalationStage: 0,
          ...
          topWeaknesses: [],
          pitchAngle: null,
          whyPriority: "Refresh failed — no data",
          reasons: ["Refresh failed"],
          valueEstimate: { monthlyLeadLoss: "$0", annualUpside: "$0", estimatedContractValue: "$0", reasoning: "No data" },
          ...
          opportunityEstimate: {
            ...
            opportunityEstimateReason: "Refresh failed — no data available yet.",
            signals: [],
          ...
          labortechFit: {
            ...
            overall: "UNKNOWN", reason: "No data available yet.",
          },
          ...
          nextAction: {
            action: "SKIP FOR NOW",
            confidence: "LOW",
            reason: "Refresh failed — no data available yet.",
          },
          websiteProof: null,
          contactPaths: [],
          contacts: {},
          scriptTone: "neutral",
          dealStrategy: { closeabilityTier: "HARD CLOSE", bestApproach: "N/A", biggestWeakness: "N/A", mainRisk: "N/A", nextTwoSteps: ["N/A", "N/A"] },
          closePlan: { step1: "N/A", step2: "N/A", step3: "N/A" },
          conversionNarrative: "Refresh failed — no data",
          closeReadiness: "NOT READY",
          nextMoveCommand: "Refresh to get data",
