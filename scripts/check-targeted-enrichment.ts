...
function briefItem(overrides: Partial<RecoveryBriefItem> & Pick<RecoveryBriefItem, "rank" | "leadKey" | "companyName">): RecoveryBriefItem {
  return {
    ...
    openerSource: overrides.openerSource ?? "fallback:no_context",
    supportingEvidence: overrides.supportingEvidence ?? "stub evidence",
    openerTrust: overrides.openerTrust ?? "WEAK",
