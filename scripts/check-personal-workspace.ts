...
assert(card.relationshipLabel === "Sphere Reengagement", "buyer tag → sphere reengagement");
assert(card.reachabilityStatus === "Reachable", "email-only contact is reachable");
