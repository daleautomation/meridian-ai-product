  ...
  return (
    <main className="recovery-brief-page">
      <section className="recovery-brief-memo" aria-label="Recovery Brief memo">
        {brief.isSample ? (
          <div className="recovery-brief-sample-banner">
            Sample · Built from public information · No CRM data accessed
          </div>
        ) : null}
        <header className="recovery-brief-header">
          <div>
            <p className="recovery-brief-kicker">{kickerPrefix} · {weekLabel}</p>
            <h1>{h1Prefix}{brief.customer} — {weekLabel}</h1>
        ...
        <footer className="recovery-brief-footer">
          ...
          {sampleDisclaimer ? <span className="sample-note">{sampleDisclaimer}</span> : null}
        </footer>
      </section>
      ...
      <style>{`
        ...
        .recovery-brief-sample-banner {
          padding: 12px clamp(28px, 4vw, 42px);
          background: #f4ead8;
        ...
        .recovery-brief-footer .sample-note {
          display: block;
          margin-top: 12px;
          padding-top: 12px;
